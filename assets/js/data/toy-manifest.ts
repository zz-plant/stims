...
export const toyManifest: ToyManifest = [
  ...
  },
  {
    ...
    "firstRunHint": "Start with the Aurora Painter preset, move or drag to steer the ribbons, scroll to swell the glow, then press Q/E or use Color Mood buttons to switch palettes.",
    "starterPreset": {
      "id": "aurora-painter",
  ...
  },
  {
    ...
    "firstRunHint": "Start with the Grid Visualizer preset, move or drag to steer the drift, scroll to lift the energy, then press Q/E or use Grid Mode buttons to switch feels.",
    "starterPreset": {
      "id": "cube-wave",
  ...
  },
  {
    ...
    "firstRunHint": "Start with the Cosmic Particles preset, move or drag to steer the orbit, scroll to deepen the pull, then press Q/E or use Cosmic Preset buttons to switch modes.",
    "starterPreset": {
      "id": "cosmic-particles",
  ...
  },
  {
    ...
    "firstRunHint": "Start with the Spiral Burst preset, move or drag to torque the spin, scroll to intensify the burst, then press Q/E or use Spiral controls to change the feel.",
    "starterPreset": {
      "id": "spiral-burst",
  ...
  },
  {
    ...
    "firstRunHint": "Start with the Rainbow Tunnel preset, move or drag to steer the tunnel, scroll to increase speed, then press Q/E or use Color Drift buttons to cycle the palette.",
    "starterPreset": {
      "id": "rainbow-tunnel",
  ...
  },
  {
    ...
    "firstRunHint": "Start with the Star Field preset, move or drag to steer drift, scroll to lift sparkle, then press Q/E or use Sky Palette buttons while watching the pulse meter.",
    "starterPreset": {
      "id": "star-field",
  ...
  },
  {
    ...
    "firstRunHint": "Start with the Bioluminescent Tidepools preset, move or drag to shape the currents, scroll to brighten the pool, then press Q/E or use Tidepool Mood buttons to shift the scene.",
    "starterPreset": {
  ...
  },
  {
    ...
    "description": "Preset-driven feedback visualizer in the lineage of Ryan Geiss's MilkDrop, with blend transitions, live source editing, and import/export flows.",

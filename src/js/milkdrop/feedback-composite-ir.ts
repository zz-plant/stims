...
export const MILKDROP_COMPOSITE_IR: FeedbackCompositeIR = {
  uniformDeclarations: [
    ...
    { kind: 'sampler2d', name: 'perlinTex' },
    { kind: 'sampler2d', name: 'audioTex' },
    { kind: 'sampler2d', name: 'warpTex' },
    { kind: 'sampler2d', name: 'blur1Tex' },
    { kind: 'sampler2d', name: 'blur2Tex' },
    { kind: 'sampler2d', name: 'blur3Tex' },
    { kind: 'float', name: 'scale1' },
    { kind: 'float', name: 'bias1' },
    { kind: 'float', name: 'scale2' },
    { kind: 'float', name: 'bias2' },
    { kind: 'float', name: 'scale3' },
    { kind: 'float', name: 'bias3' },
    ...
    { kind: 'float', name: 'vignette' },
    { kind: 'float', name: 'chromaticAberration' },
    { kind: 'vec3', name: 'tint' },
    ...
    { kind: 'float', name: 'decay' },
    { kind: 'float', name: 'hasDirectWarp' },

...
const BACKLOG = new Set<string>([
  'src/js/core/services/adaptive-quality-controller.ts',
  'src/js/core/services/captured-video-texture.ts',
  'src/js/core/services/render-service.ts',
  'src/js/core/toy-runtime.ts',
  'src/js/core/unified-input.ts',
  'src/js/frontend/AudioSourcePanel.tsx',
  'src/js/frontend/BrowseSheetPanel.tsx',
  'src/js/frontend/NewHomePage.tsx',
  'src/js/frontend/PresetGrid.tsx',
  'src/js/frontend/SettingsSheetPanel.tsx',
  'src/js/frontend/StageControls.tsx',
  'src/js/frontend/SynthesizePanel.tsx',
  'src/js/frontend/shortcut-registry.ts',
  'src/js/frontend/workspace-context.tsx',
  'src/js/frontend/workspace-helpers.ts',
  'src/js/frontend/workspace-hooks.ts',
  'src/js/frontend/workspace-shell-hooks.ts',
  'src/js/milkdrop/catalog-store-projection.ts',
  'src/js/milkdrop/compiler-types.ts',
  'src/js/milkdrop/compiler/program-assembly.ts',
  'src/js/milkdrop/compiler/shader-analysis-evaluation.ts',
  'src/js/milkdrop/compiler/shader-analysis-glsl.ts',
  'src/js/milkdrop/feedback-manager-webgpu-composite.ts',
  'src/js/milkdrop/formatter.ts',
  'src/js/milkdrop/live-tile-pool.ts',
  'src/js/milkdrop/overlay/editor-panel.ts',
  'src/js/milkdrop/overlay/preset-row.ts',
  'src/js/milkdrop/preset-generator.ts',
  'src/js/milkdrop/renderer-adapter-shared.ts',
  'src/js/milkdrop/renderer-helpers/border-renderer.ts',
  'src/js/milkdrop/renderer-helpers/particle-field-renderer.ts',
  'src/js/milkdrop/renderer-helpers/procedural-wave-renderer.ts',
  'src/js/milkdrop/renderer-helpers/shape-renderer.ts',
  'src/js/milkdrop/renderer-helpers/wave-renderer.ts',
  'src/js/milkdrop/renderer-segment-batching.ts',
  'src/js/milkdrop/renderer-types.ts',
  'src/js/milkdrop/runtime-signals.ts',
  'src/js/milkdrop/runtime/experience-frame-loop.ts',
  'src/js/milkdrop/runtime/interaction-response.ts',
  'src/js/milkdrop/runtime/preset-navigation-controller.ts',
  'src/js/milkdrop/runtime/scene-selection.ts',
  'src/js/milkdrop/vm/post-effects-builder.ts',
  'src/js/milkdrop/vm/shared.ts',
  'src/js/milkdrop/vm/wave-builder.ts',
  'src/js/ui/audio-advanced-sources.ts',
  'src/js/utils/audio/frequency-analyser-processor.ts',
  'src/js/utils/browser/gamepad-navigation.ts',
]);

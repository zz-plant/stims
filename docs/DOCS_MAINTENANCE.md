...
| --- | --- |
| New script or renamed script | `docs/DEVELOPMENT.md` plus `AGENTS.md`, `docs/agents/README.md`, `docs/agents/tooling-and-quality.md`, `docs/agents/visualizer-workflows.md`, and `docs/MCP_SERVER.md` when they reference the changed script. |

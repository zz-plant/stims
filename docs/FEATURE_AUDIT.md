...
| Library discovery, search, and empty states | [`PAGE_SPECIFICATIONS.md`](./PAGE_SPECIFICATIONS.md), [`USABILITY_AUDIT.md`](./archive/USABILITY_AUDIT.md) | The audit captures UX issues that are still open. |
...
| User critiques and assessment findings | [`stim-user-critiques.md`](./stim-user-critiques.md), [`stim-assessment.md`](./archive/stim-assessment.md) | Use these to validate UX intent against feedback. |
...
4. **Reconcile search copy with filtering behavior** — Documented in `PAGE_SPECIFICATIONS.md` and reflected in `USABILITY_AUDIT.md` (archived). ✅
